        ...
        <div className="container">
            ...
            <div class="tools-section">
                ...
                <div className="brushsize-container">
                    {
                        (eraser === false) ?
                        <img className="eraserImageDisabled" src={image } alt="Logo" onClick={handleEraser}/>
                        :
                        <img className="eraserImageEnabled" src={image } alt="Logo" onClick={handleEraser}/>
                    }
